...
def generate_and_submit_jobs(molecules, params, geom_file="geometries.txt", max_concurrent_jobs=10):
            ...
            try:
                ...
                if retry_count < 2:
                    ...
                    with DirectoryContext(state_dir):
                        ...
                        job_id = run_command(job_submission_command, f"Error resubmitting job for {molecule}")
                        if job_id:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--max-evals', type=int, default=10, help='Maximum number of evaluations')
    parser.add_argument('--molecules', nargs='+', default=["Ethene", "E-Butadiene"], 
                        help='List of molecules to optimize parameters for')
    parser.add_argument('--max-jobs', type=int, default=20, help='Maximum number of concurrent jobs')
